...
2) The full NMR records and corresponding Mnova files can be found in this dropbox:
...
Important note: Only “true” assignment are extracted. When peaks from 2D spectra are linked to atoms of molecules, they are not (yet) taken into account. (for example in the Ice_tea_lemon_partial_assignments_HSQC_assignement_of_peaks.mnova)