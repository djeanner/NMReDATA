    ...
    if length(current_line)>1%there is something usefull in this line...
        ...
        if ~found_variable%normal line of data
            ...
            if contains(tag_identyfyer,[header_tag '1D'])
                obj=extract_data_1d(obj,current_line,pieces_of_information,field_separator,verbose);
            end
            if contains(tag_identyfyer,[header_tag '2D'])
                obj=extract_data_2d(obj,current_line,pieces_of_information,field_separator,verbose);
            end
            if contains(tag_identyfyer,[header_tag 'J'])
              %  warning('not reading J yet... write function first....')
               obj=extract_data_J(obj,current_line,pieces_of_information,field_separator,verbose);

            end
            if contains(tag_identyfyer,[header_tag 'ASSIGNMENT'])
                obj=extract_data_signals(obj,current_line,pieces_of_information,field_separator,verbose);
            end
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
